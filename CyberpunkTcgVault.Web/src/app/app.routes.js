...
export const routes = [
    {
        ...
        component: Home,
        data: {
            description: 'Choom Vault is an independent, fan-made Cyberpunk TCG collector companion for discovering cards and exploring a physical card collection.',
            robots: 'index, follow'
        }
    },
    {
        ...
        data: {
            description: 'Browse the Cyberpunk TCG cards currently archived in Choom Vault using the public card catalogue, search and filters.',
            robots: 'index, follow'
        }
    },
    {
    ...
    },
    {
        ...
        data: {
            description: 'Manage the exact Cyberpunk TCG card printings in your private Choom Vault collection.',
    ...
    },
    {
        ...
        component: About,
        data: {
            description: 'Learn about Choom Vault, an independent, fan-made Cyberpunk TCG collector companion built around physical card collecting.',
            robots: 'index, follow'
        }
    },
    {
        ...
        component: Privacy,
        data: {
            description: 'Read how Choom Vault handles account, collection and privacy information as the collector companion develops.',
            robots: 'index, follow'
        }
    },
    {
        ...
        component: Contact,
        data: {
            description: 'Contact Choom Vault for project enquiries, feedback, rights, attribution or removal requests.',
            robots: 'index, follow'
        }
    },
    {
