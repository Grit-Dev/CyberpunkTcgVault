 ...
 */
export const V_STREETKID_ANATOMY = [
    {
        id: 'cost',
        title: 'Cost',
        description: 'Spend Eddies equal to this value to play the card. Legends can also be spent as 1 Eddie each.',
        region: {
            top: 3.8,
            left: 4.8,
            width: 14.2,
    ...
    },
    {
        id: 'sellTag',
        title: 'Sell Tag',
        description: 'Once per turn, a card with this symbol can be sold from your hand to create 1 Eddie.',
        region: {
            top: 16.8,
            left: 8,
            width: 10.2,
    ...
    },
    {
        id: 'ram',
        title: 'RAM',
        description: 'Your Legends set the RAM limits for your deck. A card can only be included when its colour and RAM value fit within that limit.',
        region: {
            top: 8.7,
            left: 82,
            width: 10.2,
    ...
    },
    {
        id: 'power',
        title: 'Power',
        description: 'Used when attacking. Higher power wins fights, and Units steal an additional Gig for every 10 power.',
        region: {
            top: 88.8,
            left: 82,
            width: 13,
    ...
    },
    {
        id: 'rulesText',
        title: 'Rules Text',
        description: 'Explains the card’s abilities and instructions. Card text takes priority if it conflicts with the general rules.',
        region: {
            top: 67.4,
            left: 9.5,
            width: 70,
